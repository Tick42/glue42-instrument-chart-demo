...
class InstrumentChart extends React.Component {
	render() {
		const ema20 = ema()
			.id(0)
		...
		const { type, data: initialData, width, ratio, midPrice, symbol } = this.props;
...
InstrumentChart.propTypes = {
	...
	midPrice: PropTypes.number.isRequired,
...
InstrumentChart = fitWidth(InstrumentChart);
